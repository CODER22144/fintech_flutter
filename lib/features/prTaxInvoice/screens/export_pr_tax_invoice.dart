...
class ExportPrTaxInvoice extends StatefulWidget {
  static String routeName = '/ExportPrTaxInvoice';
  const ExportPrTaxInvoice({super.key});

  @override
  State<ExportPrTaxInvoice> createState() => _ExportPrTaxInvoiceState();
}

class _ExportPrTaxInvoiceState extends State<ExportPrTaxInvoice> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
          ...
          child: const CommonAppbar(title: 'Export PR Tax Invoice')),
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              if (response.statusCode == 200) {
                                ...
                                String fileName =
                                    'pr_tax_invoice_${docnoController.text}.json';
                                String jsonString =
