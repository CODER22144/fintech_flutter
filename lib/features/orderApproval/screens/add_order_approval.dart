...
class AddOrderApproval extends StatefulWidget {
  static String routeName = "/addOrderApproval";
  final String orderId;
  const AddOrderApproval({super.key, required this.orderId});

  @override
  State<AddOrderApproval> createState() => _AddOrderApprovalState();
}

class _AddOrderApprovalState extends State<AddOrderApproval> {
  @override
  void initState() {
    super.initState();
    ...
    return Consumer<OrderApprovalProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: CommonAppbar(title: 'Order Approval For : ${widget.orderId}')),
