...
import 'package:fintech_new_web/features/productionPlanA/provider/production_plan_A_provider.dart';
...
class AddProductionPlanA extends StatefulWidget {
  static String routeName = "/addProductionPlanA";
  const AddProductionPlanA({super.key});

  @override
  State<AddProductionPlanA> createState() => _AddProductionPlanAState();
}

class _AddProductionPlanAState extends State<AddProductionPlanA> {
  ...
  void initState() {
    super.initState();
    ProductionPlanAProvider provider =
        Provider.of<ProductionPlanAProvider>(context, listen: false);
    provider.initWidget();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ProductionPlanAProvider>(
        builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            preferredSize:
                Size.fromHeight(MediaQuery.of(context).size.height * 0.07),
            child: const CommonAppbar(title: 'Add Additional Production Plan')),
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        final Uri uri = Uri.parse(
                            "https://docs.google.com/spreadsheets/d/1x8MEPdgboZt0BLhXssT5hdPu1E0jwRL5hEIANnaqMzM/edit?usp=sharing");
                            ...
                            if (formKey.currentState!.validate()) {
                              ...
                              if (confirmation) {
                                ...
                                if (result.statusCode == 200) {
                                  context.pushReplacementNamed(AddProductionPlanA.routeName);
