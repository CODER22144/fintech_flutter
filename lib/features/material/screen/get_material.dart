...
class GetMaterial extends StatefulWidget {
  static String routeName = 'edit-material';
  const GetMaterial({super.key});

  @override
  State<GetMaterial> createState() => _GetBusinessPartnerState();
}

class _GetBusinessPartnerState extends State<GetMaterial> {
        ...
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                ...
                child: const CommonAppbar(title: 'Get Material')),
