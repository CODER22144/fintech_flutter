...
class MaterialRepForm extends StatefulWidget {
  static String routeName = "/materialRepForm";
  const MaterialRepForm({super.key});

  @override
  State<MaterialRepForm> createState() => _MaterialRepFormState();
}

class _MaterialRepFormState extends State<MaterialRepForm> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<MaterialRepProvider>(builder: (context, provider, child) {
      return Scaffold(
                            ...
                            if (formKey.currentState!.validate()) {
                              ...
                              if (confirmation) {
                                ...
                                if (result.statusCode == 200) {
                                  provider.setResponse(message);
                                  context
                                      .pushNamed(MaterialRepReport.routeName);
