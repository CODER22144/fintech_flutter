...
import '../provider/material_source_provider.dart';

class MaterialSource extends StatefulWidget {
  static String routeName = "/materialSource";
  final String? editing;
  const MaterialSource({super.key, this.editing});

  @override
  State<MaterialSource> createState() => _MaterialSourceState();
}

class _MaterialSourceState extends State<MaterialSource> {
  late MaterialSourceProvider provider;
    ...
    return Consumer<MaterialSourceProvider>(
      ...
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Material Source')),
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            final Uri uri = Uri.parse(
                                "https://docs.google.com/spreadsheets/d/1_V7UF6WdEKBbQWDLoKBXH4F4qQBK7G3M8CN6EUnufL0/edit?usp=sharing");
                            ...
                            if (formKey.currentState!.validate()) {
                              ...
                              if (confirmation) {
                                ...
                                if (result.statusCode == 200) {
                                  if(widget.editing == "true") {
                                    context.pop();
                                    context.pushReplacementNamed(GetMaterialSource.routeName);
                                  } else {
                                    context.pushReplacementNamed(MaterialSource.routeName);
                                  }
    ...
    try {
      ...
      if (result != null) {
        ...
        if (sheet != null) {
          ...
          GlobalVariables.requestBody[MaterialSourceProvider.featureName]  = jsonData;
        }
      } else {
