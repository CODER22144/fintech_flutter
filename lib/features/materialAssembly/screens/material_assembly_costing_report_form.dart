...
class MaterialAssemblyCostingReportForm extends StatefulWidget {
  static String routeName = "MaterialAssemblyCostingReportForm";
  const MaterialAssemblyCostingReportForm({super.key});

  @override
  State<MaterialAssemblyCostingReportForm> createState() => _MaterialAssemblyCostingReportFormState();
}

class _MaterialAssemblyCostingReportFormState extends State<MaterialAssemblyCostingReportForm> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<MaterialAssemblyProvider>(builder: (context, provider, child) {
      return Scaffold(
                    ...
                    Visibility(
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            context.pushNamed(MaterialAssemblyCostingReport.routeName);
                          },
                          child: const Text(
                            'Submit',
                            style: TextStyle(
