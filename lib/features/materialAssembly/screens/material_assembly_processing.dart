...
import 'material_assembly_processing_row_fields.dart';
import 'material_assembly_row_fields.dart';

class MaterialAssemblyProcessing extends StatefulWidget {
  static String routeName = "MaterialAssemblyProcessing";

  const MaterialAssemblyProcessing({super.key});
  @override
  MaterialAssemblyProcessingState createState() =>
      MaterialAssemblyProcessingState();
}

class MaterialAssemblyProcessingState
    extends State<MaterialAssemblyProcessing> {
    ...
    try {
      ...
      if (result != null) {
        ...
        if (sheet != null) {
          ...
          GlobalVariables.requestBody['MaterialAssemblyProcessing'] = jsonData;
        }
      } else {
    ...
    return Consumer<MaterialAssemblyProvider>(
      ...
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Material Assembly Details')),
        body: Center(
          child: Column(
            children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      for (int i = 0; i < tableRows.length; i++)
                        Visibility(
                          visible: manualOrder,
                          child: MaterialAssemblyProcessingRowFields(
                              addRow: addRow,
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                final Uri uri = Uri.parse(
                                    "https://docs.google.com/spreadsheets/d/1oV7HCYAwuyoq52Fw4IVEn4Q423UrZ6_6k9dikOu1p1c/edit?usp=sharing");
