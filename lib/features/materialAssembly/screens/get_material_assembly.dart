...
class GetMaterialAssembly extends StatefulWidget {
  static String routeName = 'GetMaterialAssembly12';
  const GetMaterialAssembly({super.key});

  @override
  State<GetMaterialAssembly> createState() => _GetMaterialAssemblyState();
}

class _GetMaterialAssemblyState extends State<GetMaterialAssembly> {
  @override
  void initState() {
    super.initState();
        ...
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                ...
                child: const CommonAppbar(title: "Update Material Assembly")),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              context.pushNamed(MaterialAssembly.routeName, extra: true);
                            },
                            child: const Text(
                              'Submit',
                              style: TextStyle(
