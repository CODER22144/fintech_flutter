...
class MaterialAssemblyDetails extends StatefulWidget {
  static String routeName = "materialAssemblyDetails";

  const MaterialAssemblyDetails({super.key});
  @override
  MaterialAssemblyDetailsState createState() => MaterialAssemblyDetailsState();
}

class MaterialAssemblyDetailsState extends State<MaterialAssemblyDetails> {
    ...
    try {
      ...
      if (result != null) {
        ...
        if (sheet != null) {
          ...
          GlobalVariables.requestBody['MaterialAssemblyDetails'] = jsonData;
        }
      } else {
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                http.StreamedResponse result =
                                    await provider.addMaterialAssemblyDetails(tableRows, manualOrder);
                      ...
                      for (int i = 0; i < tableRows.length; i++)
                        Visibility(
                          visible: manualOrder,
                          child: MaterialAssemblyRowFields(
                              addRow: addRow,
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                final Uri uri = Uri.parse(
                                    "https://docs.google.com/spreadsheets/d/1y1As1GsjxR5ze20tjjuMDdcwdIlzpanVOhcfydQTYtQ/edit?usp=sharing");
