...
class DeleteMaterialAssembly extends StatefulWidget {
  static String routeName = 'DeleteMaterialAssembly';
  const DeleteMaterialAssembly({super.key});

  @override
  State<DeleteMaterialAssembly> createState() => _DeleteMaterialAssemblyState();
}

class _DeleteMaterialAssemblyState extends State<DeleteMaterialAssembly> {
  @override
  void initState() {
    super.initState();
    ...
    return Consumer<MaterialAssemblyProvider>(
      ...
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: "Delete Material Assembly")),
                            ...
                            if (confirmation) {
                              ...
                              if (response.statusCode == 200) {
                                context.pushReplacementNamed(
                                    DeleteMaterialAssembly.routeName);
                              }
                            }
                          },
                          child: const Text(
