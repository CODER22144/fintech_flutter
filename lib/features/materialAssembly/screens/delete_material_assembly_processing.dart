...
class DeleteMaterialAssemblyProcessing extends StatefulWidget {
  static String routeName = 'DeleteMaterialAssemblyProcessing';
  const DeleteMaterialAssemblyProcessing({super.key});

  @override
  State<DeleteMaterialAssemblyProcessing> createState() => _DeleteMaterialAssemblyProcessingState();
}

class _DeleteMaterialAssemblyProcessingState extends State<DeleteMaterialAssemblyProcessing> {
  @override
  void initState() {
    super.initState();
        ...
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                ...
                child: const CommonAppbar(title: "Delete Material Assembly Processing")),
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              http.StreamedResponse response = await networkService
                                  .post("/get-material-assembly-processing/",
                          ...
                          onPressed: () async {
                            ...
                            if (confirmation) {
                              ...
                              await networkService.post(
                                  "/delete-mat-assembly-processing/",
                                  {"mapId": '${data['mapId']}'});
                              if (response.statusCode == 200) {
