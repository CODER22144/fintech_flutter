...
class ObMaterialScreen extends StatefulWidget {
  static String routeName = "/ObMaterial";
  final String? editing;
  const ObMaterialScreen({super.key, this.editing});

  @override
  State<ObMaterialScreen> createState() => _ObMaterialScreenState();
}

class _ObMaterialScreenState extends State<ObMaterialScreen> {
  late ObMaterialProvider provider;
  ...
  void initState() {
    super.initState();
    provider = Provider.of<ObMaterialProvider>(context, listen: false);
    ...
    return Consumer<ObMaterialProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'OB Material')),
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            final Uri uri = Uri.parse(
                                "https://docs.google.com/spreadsheets/d/10h_RH23wEvHVg3cVg4lR4hQvqjt58jtme5_aVAqLW3c/edit?usp=sharing");
    ...
    try {
      ...
      if (result != null) {
        ...
        if (sheet != null) {
          ...
          GlobalVariables.requestBody[ObMaterialProvider.featureName] = [];
          GlobalVariables.requestBody[ObMaterialProvider.featureName]  = jsonData;
        }
      } else {
