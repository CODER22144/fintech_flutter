...
class GetB2bNotIn extends StatefulWidget {
  static String routeName = 'GetB2bNotIn';
  const GetB2bNotIn({super.key});

  @override
  State<GetB2bNotIn> createState() => _GetB2bNotInState();
}

class _GetB2bNotInState extends State<GetB2bNotIn> {
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              context.pushNamed(B2bNotInReport.routeName);
                            },
                            child: const Text(
                              'Submit',
                              style: TextStyle(
