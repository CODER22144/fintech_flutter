...
class AddVisitInfo extends StatefulWidget {
  static String routeName = "/visitInfo";
  const AddVisitInfo({super.key});

  @override
  State<AddVisitInfo> createState() => _AddVisitInfoState();
}

class _AddVisitInfoState extends State<AddVisitInfo> {
  @override
  void initState() {
    super.initState();
    ...
    return Consumer<VisitInfoProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Add Visit Info')),
                            ...
                            if (formKey.currentState!.validate()) {
                              ...
                              if (confirmation) {
                                ...
                                if (result.statusCode == 200) {
                                  context.pushReplacementNamed(AddVisitInfo.routeName);
