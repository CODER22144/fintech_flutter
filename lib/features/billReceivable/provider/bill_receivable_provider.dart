...
class BillReceivableProvider with ChangeNotifier {
  static const String featureName = "billReceivable";
  ...
  Future<http.StreamedResponse> processFormInfo() async {
    http.StreamedResponse response = await networkService.post(
        "/add-bill-receivable/", [GlobalVariables.requestBody[featureName]]);
    return response;
  }
