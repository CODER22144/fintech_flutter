...
class CreateOBalance extends StatefulWidget {
  static String routeName = "/createObalance";
  final String? editing;
  const CreateOBalance({super.key, this.editing});

  @override
  State<CreateOBalance> createState() => _CreateOBalanceState();
}

class _CreateOBalanceState extends State<CreateOBalance> {
  @override
  void initState() {
    super.initState();
    ...
    return Consumer<OBalanceProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Add OBalance')),
                            ...
                            if (formKey.currentState!.validate()) {
                              ...
                              if (confirmation) {
                                ...
                                if (result.statusCode == 200) {
                                  context.pushReplacementNamed(CreateOBalance.routeName);
