...
class PartAssemblyProcessingRowField extends StatefulWidget {
  final int index;
  ...
  const PartAssemblyProcessingRowField(
      {super.key,
        required this.index,
  ...
  @override
  State<PartAssemblyProcessingRowField> createState() => _PartAssemblyProcessingRowFieldState();
}

class _PartAssemblyProcessingRowFieldState extends State<PartAssemblyProcessingRowField> {
