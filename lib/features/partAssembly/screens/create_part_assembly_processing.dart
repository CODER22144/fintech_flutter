...
class CreatePartAssemblyProcessing extends StatefulWidget {
  static String routeName = "CreatePartAssemblyProcessing";

  const CreatePartAssemblyProcessing({super.key});

  @override
  CreatePartAssemblyProcessingState createState() => CreatePartAssemblyProcessingState();
}

class CreatePartAssemblyProcessingState extends State<CreatePartAssemblyProcessing> {
    ...
    return Consumer<PartAssemblyProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Append Part Assembly Processing')),
        body: Center(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            http.StreamedResponse result = await provider
                                .addPartAssemblyProcessing(tableRows, manualOrder);
                            var message =
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              context.pushNamed(PartAssemblyProcessingTable.routeName);
                            },
                          ),
                        ),
                        Visibility(
                    ...
                    for (int i = 0; i < tableRows.length; i++)
                      Visibility(
                        visible: manualOrder,
                        child: PartAssemblyProcessingRowField(
                            index: i,
                            tableRows: tableRows,
                            deleteRow: deleteRow,
    ...
    try {
      ...
      if (result != null) {
        ...
        if (sheet != null) {
          ...
          GlobalVariables.requestBody['PartAssemblyProcessing'] = [];
          GlobalVariables.requestBody['PartAssemblyProcessing'] = jsonData;
        }
      } else {
