...
class PartAssemblyDetails extends StatefulWidget {
  static String routeName = "partAssemblyDetails";

  const PartAssemblyDetails({super.key});

  @override
  PartAssemblyDetailsState createState() => PartAssemblyDetailsState();
}

class PartAssemblyDetailsState extends State<PartAssemblyDetails>
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (result.statusCode == 200) {
                                          context.pushReplacementNamed(PartAssemblyDetails.routeName);
                              ...
                              Row(
                                ...
                                children: [
                                  ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      http.StreamedResponse result =
                                          await provider.addPartAssemblyDetails(
                              ...
                              Row(
                                ...
                                children: [
                                  ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      http.StreamedResponse result =
                                          await provider.addPartAssemblyProcessing(processingTableRows, manualOrder1);
                                      var message = jsonDecode(
                                          await result.stream.bytesToString());
                                      if (result.statusCode == 200) {
                                        context.pushReplacementNamed(PartAssemblyDetails.routeName);
