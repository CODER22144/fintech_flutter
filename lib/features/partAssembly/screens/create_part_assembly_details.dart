...
class CreatePartAssemblyDetails extends StatefulWidget {
  static String routeName = "CreatePartAssemblyDetails";

  const CreatePartAssemblyDetails({super.key});

  @override
  CreatePartAssemblyDetailsState createState() => CreatePartAssemblyDetailsState();
}

class CreatePartAssemblyDetailsState extends State<CreatePartAssemblyDetails> {
    ...
    return Consumer<PartAssemblyProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Append Part Assembly Details')),
        body: Center(
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            http.StreamedResponse result = await provider
                                .addPartAssemblyDetails(tableRows, manualOrder);
                            var message =
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              context.pushNamed(PartAssemblyDetailsMasterTable.routeName);
                            },
                          ),
                        ),
                        Visibility(
    ...
    try {
      ...
      if (result != null) {
        ...
        if (sheet != null) {
          ...
          GlobalVariables.requestBody['PartAssemblyDetails'] = [];
          GlobalVariables.requestBody['PartAssemblyDetails'] = jsonData;
        }
      } else {
