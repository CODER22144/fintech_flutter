...
class GetPartAssembly extends StatefulWidget {
  static String routeName = 'GetPartAssembly';
  const GetPartAssembly({super.key});

  @override
  State<GetPartAssembly> createState() => _GetPartAssemblyState();
}

class _GetPartAssemblyState extends State<GetPartAssembly> {

  @override
  void initState() {
    super.initState();
    PartAssemblyProvider provider = Provider.of<PartAssemblyProvider>(context, listen: false);
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              context.pushNamed(UpdatePartAssembly.routeName);
                            },
                            child: const Text(
                              'Submit',
                              style: TextStyle(
