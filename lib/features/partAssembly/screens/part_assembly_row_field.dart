...
class PartAssemblyRowField extends StatefulWidget {
  final int index;
  ...
  @override
  State<PartAssemblyRowField> createState() => _PartAssemblyRowFieldState();
}

class _PartAssemblyRowFieldState extends State<PartAssemblyRowField> {
