...
class BpProcessing extends StatefulWidget {
  static String routeName = "/BpProcessing";
  final String? editing;
  const BpProcessing({super.key, this.editing});

  @override
  State<BpProcessing> createState() => _PaymentPendingState();
}

class _PaymentPendingState extends State<BpProcessing> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<BpProcessingProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            preferredSize:
            Size.fromHeight(MediaQuery.of(context).size.height * 0.07),
            child: const CommonAppbar(title: 'Business Partner Processing')),
