...
class PrTaxInvoiceDispatchProvider with ChangeNotifier {
  String featureName = "prTaxInvoiceDispatch";
  ...
  Future<http.StreamedResponse> processFormInfo() async {
    http.StreamedResponse response = await networkService.post(
        "/add-pr-tax-invoice-dispatch/", [GlobalVariables.requestBody[featureName]]);
    return response;
  }
}