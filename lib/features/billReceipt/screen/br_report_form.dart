...
class BrReportForm extends StatefulWidget {
  static String routeName = "BrReportForm";
  const BrReportForm({super.key});

  @override
  State<BrReportForm> createState() => _BrReportFormState();
}

class _BrReportFormState extends State<BrReportForm> {
  @override
  void initState() {
    super.initState();
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                if (formKey.currentState!.validate()) {
                                  context.pushNamed(BrReport.routeName);
                                }
                              },
                              child: const Text(
                                'Submit',
