...
class Resources extends StatefulWidget {
  ...
  const Resources({super.key, this.editing});
        ...
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                ...
                child: const CommonAppbar(title: 'Resources')),
                                ...
                                if (formKey.currentState!.validate()) {
                                  ...
                                  if (confirmation) {
                                    ...
                                    if (result.statusCode == 200) {
                                      if(widget.editing == "true") {
                                        context.pop();
                                        context.pushReplacementNamed(GetResources.routeName);
                                      } else {
                                        context.pushReplacementNamed(Resources.routeName);
                                      }
