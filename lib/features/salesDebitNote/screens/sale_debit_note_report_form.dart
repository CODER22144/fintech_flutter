...
import 'package:fintech_new_web/features/salesDebitNote/screens/sale_debit_note_report.dart';
...
class SaleDebitNoteReportForm extends StatefulWidget {
  static String routeName = "SaleDebitNoteReportForm";
  const SaleDebitNoteReportForm({super.key});

  @override
  State<SaleDebitNoteReportForm> createState() =>
      _SaleDebitNoteReportFormState();
}

class _SaleDebitNoteReportFormState extends State<SaleDebitNoteReportForm> {
  @override
  void initState() {
    super.initState();
                        ...
                        Visibility(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                context.pushNamed(SaleDebitNoteReport.routeName);
                              },
                              child: const Text(
                                'Submit',
                                style: TextStyle(
