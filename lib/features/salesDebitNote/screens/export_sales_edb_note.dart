...
class ExportSalesEdbNote extends StatefulWidget {
  static String routeName = '/ExportSalesEdbNote';
  const ExportSalesEdbNote({super.key});

  @override
  State<ExportSalesEdbNote> createState() => _ExportSalesEdbNoteState();
}

class _ExportSalesEdbNoteState extends State<ExportSalesEdbNote> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
          ...
          child: const CommonAppbar(title: 'Export Sales Debit Note')),
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              if (response.statusCode == 200) {
                                ...
                                String fileName =
                                    'sale_db_note_${docnoController.text}.json';
                                String jsonString =
