...
import 'package:fintech_new_web/features/partSubAssembly/screens/part_sub_assembly_report.dart';
...
class PartSubAssemblyReportForm extends StatefulWidget {
  static String routeName = "PartSubAssemblyReportForm";
  const PartSubAssemblyReportForm({super.key});

  @override
  State<PartSubAssemblyReportForm> createState() =>
      _PartSubAssemblyReportFormState();
}

class _PartSubAssemblyReportFormState extends State<PartSubAssemblyReportForm> {
  @override
  void initState() {
    super.initState();
                        ...
                        Visibility(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                context.pushNamed(PartSubAssemblyReport.routeName);
                              },
                              child: const Text(
                                'Submit',
                                style: TextStyle(
