...
class PartSubAssemblyRowField extends StatefulWidget {
  final int index;
  ...
  @override
  State<PartSubAssemblyRowField> createState() => _PartSubAssemblyRowFieldState();
}

class _PartSubAssemblyRowFieldState extends State<PartSubAssemblyRowField> {
