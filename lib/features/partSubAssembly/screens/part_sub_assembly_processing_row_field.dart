...
class PartSubAssemblyProcessingRowField extends StatefulWidget {
  final int index;
  ...
  const PartSubAssemblyProcessingRowField(
      {super.key,
        required this.index,
  ...
  @override
  State<PartSubAssemblyProcessingRowField> createState() => _PartSubAssemblyProcessingRowFieldState();
}

class _PartSubAssemblyProcessingRowFieldState extends State<PartSubAssemblyProcessingRowField> {
