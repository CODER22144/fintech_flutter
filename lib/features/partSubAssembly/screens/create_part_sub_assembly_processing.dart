...
import 'package:fintech_new_web/features/partSubAssembly/screens/part_sub_assembly_processing_table.dart';
...
class CreatePartSubAssemblyProcessing extends StatefulWidget {
  static String routeName = "CreatePartSubAssemblyProcessing";

  const CreatePartSubAssemblyProcessing({super.key});

  @override
  CreatePartSubAssemblyProcessingState createState() => CreatePartSubAssemblyProcessingState();
}

class CreatePartSubAssemblyProcessingState extends State<CreatePartSubAssemblyProcessing> {
    ...
    return Consumer<PartSubAssemblyProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Append Part Sub Assembly Processing')),
        body: Center(
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            http.StreamedResponse result = await provider
                                .addPartSubAssemblyProcessing(tableRows, manualOrder);
                            var message =
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              context.pushNamed(PartSubAssemblyProcessingTable.routeName);
                            },
                          ),
                        ),
                        Visibility(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            final Uri uri = Uri.parse(
                                "https://docs.google.com/spreadsheets/d/1PispyP4cgmsQyow-114xuSes2g8oc5XmyUES7majytI/edit?usp=sharing");
    ...
    try {
      ...
      if (result != null) {
        ...
        if (sheet != null) {
          ...
          GlobalVariables.requestBody['PartSubAssemblyProcessing'] = jsonData;
        }
      } else {
