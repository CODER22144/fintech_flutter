...
class GetMaterialIqs extends StatefulWidget {
  static String routeName = 'edit-material-iqs';
  const GetMaterialIqs({super.key});

  @override
  State<GetMaterialIqs> createState() => _GetMaterialIqsState();
}

class _GetMaterialIqsState extends State<GetMaterialIqs> {
  @override
    ...
    return Consumer<MaterialIQSProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Get Material IQS')),
