...
class ExportEdbNote extends StatefulWidget {
  static String routeName = '/ExportEdbNote';
  const ExportEdbNote({super.key});

  @override
  State<ExportEdbNote> createState() => _ExportEdbNoteState();
}

class _ExportEdbNoteState extends State<ExportEdbNote> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
          ...
          child: const CommonAppbar(title: 'Export E-Debit Note')),
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              if (response.statusCode == 200) {
                                ...
                                String fileName =
                                    'db_note_${docnoController.text}.json';
                                String jsonString =
