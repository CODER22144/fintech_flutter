...
class AddMaterialIncomingStandard extends StatefulWidget {
  static String routeName = "/AddMaterialIncomingStandard";

  const AddMaterialIncomingStandard({super.key});

  @override
  State<AddMaterialIncomingStandard> createState() => _AddMaterialIncomingStandardState();
}

class _AddMaterialIncomingStandardState extends State<AddMaterialIncomingStandard> {
  late MaterialIncomingStandardProvider provider;
  ...
  void initState() {
    super.initState();
    provider = Provider.of<MaterialIncomingStandardProvider>(context, listen: false);
    provider.initWidget();
  }
        ...
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                ...
                child: const CommonAppbar(title: 'Add Material Incoming Standard')),
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            final Uri uri = Uri.parse(
                                "https://docs.google.com/spreadsheets/d/1jqiXMm2vkuU7jkNK3Y5pTPEX9pbM907Atp3EtNR1Cbw/edit?usp=sharing");
    ...
    try {
      ...
      if (result != null) {
        ...
        if (sheet != null) {
          ...
          GlobalVariables.requestBody[MaterialIncomingStandardProvider.featureName] =
              jsonData;
        }
      } else {
