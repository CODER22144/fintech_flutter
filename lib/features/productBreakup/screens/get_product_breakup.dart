...
class GetProductBreakup extends StatefulWidget {
  static String routeName = 'GetProductBreakup';
  const GetProductBreakup({super.key});

  @override
  State<GetProductBreakup> createState() => _GetProductBreakupState();
}

class _GetProductBreakupState extends State<GetProductBreakup> {
        ...
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                ...
                child: const CommonAppbar(title: 'Update Product Breakup')),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              context.pushNamed(UpdateProductBreakup.routeName);
                            },
                            child: const Text(
                              'Submit',
                              style: TextStyle(
