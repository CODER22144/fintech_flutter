...
import 'package:fintech_new_web/features/productBreakup/screens/product_breakup_processing_table.dart';
...
class CreateProductBreakupProcessing extends StatefulWidget {
  static String routeName = "CreateProductBreakupProcessing";

  const CreateProductBreakupProcessing({super.key});

  @override
  CreateProductBreakupProcessingState createState() => CreateProductBreakupProcessingState();
}

class CreateProductBreakupProcessingState extends State<CreateProductBreakupProcessing> {
    ...
    return Consumer<ProductBreakupProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Append Product Breakup Processing')),
        body: Center(
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            http.StreamedResponse result = await provider
                                .addProductBreakupProcessing(tableRows, manualOrder);
                            var message =
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              context.pushNamed(ProductBreakupProcessingTable.routeName);
                            },
                          ),
                        ),
                        Visibility(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            final Uri uri = Uri.parse(
                                "https://docs.google.com/spreadsheets/d/1p3rlxLsvsxrSyDIAQ4vDGs_1UmLXX1NMC6t-NPAWUVs/edit?usp=sharing");
    ...
    try {
      ...
      if (result != null) {
        ...
        if (sheet != null) {
          ...
          GlobalVariables.requestBody['ProductBreakupProcessing'] = jsonData;
        }
      } else {
