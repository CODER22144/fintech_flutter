...
import 'package:fintech_new_web/features/productBreakup/screens/product_breakup_details_master_table.dart';
...
class CreateProductBreakupDetails extends StatefulWidget {
  static String routeName = "CreateProductBreakupDetails";

  const CreateProductBreakupDetails({super.key});

  @override
  CreateProductBreakupDetailsState createState() => CreateProductBreakupDetailsState();
}

class CreateProductBreakupDetailsState extends State<CreateProductBreakupDetails> {
    ...
    return Consumer<ProductBreakupProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Append Product Breakup Details')),
        body: Center(
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            http.StreamedResponse result = await provider
                                .addProductBreakupDetails(tableRows, manualOrder);
                            var message =
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              context.pushNamed(ProductBreakupDetailsMasterTable.routeName);
                            },
                          ),
                        ),
                        Visibility(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            final Uri uri = Uri.parse(
                                "https://docs.google.com/spreadsheets/d/19cU6K6__onhu5HxLyO0cHIQBzBM-ZMJ4OcGOaqMrS2c/edit?usp=sharing");
    ...
    try {
      ...
      if (result != null) {
        ...
        if (sheet != null) {
          ...
          GlobalVariables.requestBody['ProductBreakupDetails'] = jsonData;
        }
      } else {
