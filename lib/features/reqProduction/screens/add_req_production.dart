...
class AddReqProduction extends StatefulWidget {
  static String routeName = "/AddReqProduction";
  final String details;
  const AddReqProduction({super.key, required this.details});

  @override
  State<AddReqProduction> createState() => _AddReqProductionState();
}

class _AddReqProductionState extends State<AddReqProduction> {
  late ReqProductionProvider provider;
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ReqProductionProvider>(
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                preferredSize:
                Size.fromHeight(MediaQuery.of(context).size.height * 0.07),
                child: const CommonAppbar(title: 'Add Req. Production')),
