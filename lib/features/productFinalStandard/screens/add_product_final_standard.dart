...
class AddProductFinalStandard extends StatefulWidget {
  static String routeName = "/addProductFinalStandard";
  final String? editing;
  const AddProductFinalStandard({super.key, this.editing});

  @override
  State<AddProductFinalStandard> createState() =>
      _AddProductFinalStandardState();
}

class _AddProductFinalStandardState
    extends State<AddProductFinalStandard> {
  ...
  void initState() {
    super.initState();
    ProductFinalStandardProvider provider =
    Provider.of<ProductFinalStandardProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ProductFinalStandardProvider>(
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                ...
                child:
                const CommonAppbar(title: 'Add Product Final Standard')),
                                  ...
                                  if (confirmation) {
                                    ...
                                    if (result.statusCode == 200) {
                                      context.pushReplacementNamed(
                                          AddProductFinalStandard.routeName);
