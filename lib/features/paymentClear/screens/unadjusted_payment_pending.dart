...
class UnadjustedPaymentPending extends StatefulWidget {
  ...
  @override
  State<UnadjustedPaymentPending> createState() => _UnadjustedPaymentPendingState();
}
            ...
            child: Scaffold(
              ...
              body: SingleChildScrollView(
                ...
                child: SingleChildScrollView(
                  ...
                  child: provider.paymentUnadjustedPending.isNotEmpty ? DataTable(
                    columns: const [
                    ...
                    rows: provider.paymentUnadjustedPending.map((data) {
                      return DataRow(cells: [
                        ...
                        DataCell(ElevatedButton(
                          ...
                          onPressed: () async {
                            data['vtype'] = data['ptype'];
                            data['payId'] = data['docno'];
                            data['unadjusted'] = data['bamount'];

                            if(data['ptype'] == 'S') {
                              context.pushNamed(AddSaleTransferClear.routeName, queryParameters: {
