...
class CreateReceiptVoucher extends StatefulWidget {
  ...
  const CreateReceiptVoucher({super.key});
...
class _CreateReceiptVoucherState extends State<CreateReceiptVoucher> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ReceiptVoucherProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            preferredSize:
            Size.fromHeight(MediaQuery.of(context).size.height * 0.07),
            child: const CommonAppbar(title: 'Create Receipt Voucher')),
                            ...
                            if (formKey.currentState!.validate()) {
                              ...
                              if (confirmation) {
                                ...
                                if (result.statusCode == 200) {
                                  context.pushReplacementNamed(CreateReceiptVoucher.routeName);
