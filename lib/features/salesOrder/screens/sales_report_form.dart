...
import 'package:fintech_new_web/features/salesOrder/screens/sales_report.dart';
...
class SalesReportForm extends StatefulWidget {
  static String routeName = "SalesReportForm";
  const SalesReportForm({super.key});

  @override
  State<SalesReportForm> createState() => _SalesReportFormState();
}
        ...
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                ...
                child: const CommonAppbar(title: 'Get Sales Report')),
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                if (formKey.currentState!.validate()) {
                                  context.pushNamed(SalesReport.routeName);
                                }
                              },
                              child: const Text(
                                'Submit',
