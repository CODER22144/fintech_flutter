...
class SalesOrderReportForm extends StatefulWidget {
  static String routeName = "salesOrderReportForm";
  const SalesOrderReportForm({super.key});

  @override
  State<SalesOrderReportForm> createState() => _SalesOrderReportFormState();
}

class _SalesOrderReportFormState extends State<SalesOrderReportForm> {
  @override
  void initState() {
    super.initState();
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                if (formKey.currentState!.validate()) {
                                  context.pushNamed(SalesOrderReport.routeName);
                                }
                              },
                              child: const Text(
                                'Submit',
