...
class AddPurchaseTransfer extends StatefulWidget {
  static String routeName = "/addPurchaseTransfer";
  final String details;
  const AddPurchaseTransfer({super.key, required this.details});

  @override
  State<AddPurchaseTransfer> createState() => _AddPurchaseTransferState();
}

class _AddPurchaseTransferState extends State<AddPurchaseTransfer> {
  @override
  void initState() {
    super.initState();
    ...
    return Consumer<PurchaseTransferProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Add Purchase Transfer')),
