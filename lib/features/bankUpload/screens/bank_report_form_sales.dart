...
class BankReportFormSales extends StatefulWidget {
  static String routeName = "BankReportFormSales";
  const BankReportFormSales({super.key});

  @override
  State<BankReportFormSales> createState() => _BankReportFormSalesState();
}

class _BankReportFormSalesState extends State<BankReportFormSales> {
  @override
  void initState() {
    super.initState();
    BankProvider provider = Provider.of<BankProvider>(context, listen: false);
    provider.initReportS();
  }
