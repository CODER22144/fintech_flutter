...
class AddOrderGoodsDispatch extends StatefulWidget {
  static String routeName = "/addOrderDispatch";
  final String orderId;
  const AddOrderGoodsDispatch({super.key, required this.orderId});

  @override
  State<AddOrderGoodsDispatch> createState() => _AddOrderGoodsDispatchState();
}

class _AddOrderGoodsDispatchState extends State<AddOrderGoodsDispatch> {
  @override
  void initState() {
    super.initState();
    ...
    return Consumer<OrderGoodsDispatchProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: CommonAppbar(title: 'Order Goods Dispatch For : ${widget.orderId}')),
