...
class BpObMaterialForm extends StatefulWidget {
  static String routeName = "BpObMaterialForm";
  const BpObMaterialForm({super.key});

  @override
  State<BpObMaterialForm> createState() =>
      _BpObMaterialFormState();
}

class _BpObMaterialFormState extends State<BpObMaterialForm> {
  @override
  void initState() {
    super.initState();
    BpObMaterialProvider provider =
    Provider.of<BpObMaterialProvider>(context, listen: false);
    provider.initReport();
  }
                        ...
                        Visibility(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                context.pushNamed(BpObReport.routeName);
                              },
                              child: const Text(
                                'Submit',
                                style: TextStyle(
