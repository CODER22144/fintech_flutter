...
import '../provider/work_process_provider.dart';

class GetWorkProcess extends StatefulWidget {
  static String routeName = 'GetWorkProcess';
  const GetWorkProcess({super.key});

  @override
  State<GetWorkProcess> createState() => _GetWorkProcessState();
}

class _GetWorkProcessState extends State<GetWorkProcess> {
  late WorkProcessProvider provider;

  @override
  void initState() {
    super.initState();
    provider = Provider.of<WorkProcessProvider>(context, listen: false);
    ...
    return Consumer<WorkProcessProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Get Work Process')),
