...
class UnadjustedPaymentInward extends StatefulWidget {
  ...
  @override
  State<UnadjustedPaymentInward> createState() => _UnadjustedPaymentInwardState();
}
        ...
        child: SafeArea(
            child: Scaffold(
              appBar: PreferredSize(
                  ...
                  child: const CommonAppbar(title: 'Unadjusted Payment Inward Pending')),
              body: SingleChildScrollView(
                scrollDirection: Axis.vertical,
                child: SingleChildScrollView(
                  scrollDirection: Axis.horizontal,
                  child: provider.unadjPaymentInward.isNotEmpty ? DataTable(
                    columns: const [
                    ...
                    rows: provider.unadjPaymentInward.map((data) {
                      return DataRow(cells: [
                        ...
                        DataCell(ElevatedButton(
                          ...
                          onPressed: () async {
                            if(data['ptype'] == 'C') {
                              context.pushNamed(AddCrNoteClear.routeName, queryParameters: {
