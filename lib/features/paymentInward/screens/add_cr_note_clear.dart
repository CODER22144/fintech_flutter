...
class AddCrNoteClear extends StatefulWidget {
  static String routeName = "addCrNoteClear";
  final String details;
  const AddCrNoteClear({super.key, required this.details});

  @override
  State<AddCrNoteClear> createState() => _AddCrNoteClearState();
}

class _AddCrNoteClearState extends State<AddCrNoteClear> {
  @override
  void initState() {
    super.initState();
    ...
    return Consumer<PaymentInwardProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: "Add Credit Note Clear")),
                            ...
                            if (formKey.currentState!.validate()) {
                              bool confirmation =
                                  await showConfirmationDialogue(
                                      ...
                                      "CANCEL");
                              if (confirmation) {
                                http.StreamedResponse result = await provider.addCrNoteClear();
