...
class JobWorkoutReportForm extends StatefulWidget {
  static String routeName = "JobWorkoutReportForm";
  const JobWorkoutReportForm({super.key});

  @override
  State<JobWorkoutReportForm> createState() =>
      _JobWorkoutReportFormState();
}

class _JobWorkoutReportFormState extends State<JobWorkoutReportForm> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<JobWorkOutProvider>(
                        ...
                        Visibility(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                context.pushNamed(JobWorkoutReport.routeName);
                              },
                              child: const Text(
                                'Submit',
                                style: TextStyle(
