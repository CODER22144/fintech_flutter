...
class AddJobWorkOutChallanClear extends StatefulWidget {
  static String routeName = "/addJobWorkOutChallanClear";
  const AddJobWorkOutChallanClear({super.key});

  @override
  State<AddJobWorkOutChallanClear> createState() =>
      _AddJobWorkOutChallanClearState();
}

class _AddJobWorkOutChallanClearState extends State<AddJobWorkOutChallanClear> {
  @override
  void initState() {
    super.initState();
    JobWorkOutChallanClearProvider provider =
        Provider.of<JobWorkOutChallanClearProvider>(context, listen: false);
    provider.initWidget();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<JobWorkOutChallanClearProvider>(
        builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            preferredSize:
                Size.fromHeight(MediaQuery.of(context).size.height * 0.07),
            child: const CommonAppbar(title: 'Job WorkOut Challan Clear')),
                              ...
                              if (confirmation) {
                                ...
                                if (result.statusCode == 200) {
                                  context.pushReplacementNamed(
                                      AddJobWorkOutChallanClear.routeName);
