...
import 'package:fintech_new_web/features/inward/screens/tds_report.dart';
...
class TdsReportForm extends StatefulWidget {
  static String routeName = "TdsReportForm";
  const TdsReportForm({super.key});

  @override
  State<TdsReportForm> createState() =>
      _TdsReportFormState();
}

class _TdsReportFormState extends State<TdsReportForm> {
  @override
  void initState() {
    super.initState();
    InwardProvider provider =
    Provider.of<InwardProvider>(context, listen: false);
    provider.initTdsReport();
  }
                        ...
                        Visibility(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                context.pushNamed(TdsReport.routeName);
                              },
                              child: const Text(
                                'Submit',
                                style: TextStyle(
