...
class AddReqPacking extends StatefulWidget {
  static String routeName = "/AddReqPacking";
  final String details;
  const AddReqPacking({super.key, required this.details});

  @override
  State<AddReqPacking> createState() => _AddReqPackingState();
}

class _AddReqPackingState extends State<AddReqPacking> {
  late ReqPackingProvider provider;
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ReqPackingProvider>(
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                preferredSize:
                Size.fromHeight(MediaQuery.of(context).size.height * 0.07),
                child: const CommonAppbar(title: 'Add Req. Packing')),
