...
class AddLineRejection extends StatefulWidget {
  static String routeName = "/AddLineRejection";
  const AddLineRejection({super.key});

  @override
  State<AddLineRejection> createState() => _AddLineRejectionState();
}

class _AddLineRejectionState extends State<AddLineRejection> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<LineRejectionProvider>(
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                preferredSize:
                Size.fromHeight(MediaQuery.of(context).size.height * 0.07),
                child: const CommonAppbar(title: 'Add Line Rejection')),
                                ...
                                if (formKey.currentState!.validate()) {
                                  ...
                                  if (confirmation) {
                                    ...
                                    if (result.statusCode == 200) {
                                      context.pushReplacementNamed(AddLineRejection.routeName);
